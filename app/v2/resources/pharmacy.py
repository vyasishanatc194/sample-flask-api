...
from app.v1.models.pharmacy import ca_pharmacy_list_model

from app.v1.decorators import jwt_required
from app.v1.authorizations import authorizations_access_token, authorizations
from app.v1.parser import get_request_argument
...
class PharmacySearch(Resource):
    ...
    @pharmacy_ns.marshal_with(ca_pharmacy_list_model)
    def get(self):
